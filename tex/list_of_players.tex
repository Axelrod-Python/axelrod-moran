...
\item Fortress3 - \textit{Deterministic} - \textit{Memory depth}: 3 - \textit{Number of states}: 3. \cite{Ashlock2006b}
\item Fortress4 - \textit{Deterministic} - \textit{Memory depth}: 4 - \textit{Number of states}: 4. \cite{Ashlock2006b}
...
\item Predator - \textit{Deterministic} - \textit{Memory depth}: 9 - \textit{Number of states}: 9. \cite{Ashlock2006b}
