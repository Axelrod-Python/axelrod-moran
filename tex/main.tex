...
% TODO Compare fixation rates to neutral fixation 1/2 (because we're in the N/2)
% case.
...
\begin{figure}[!hbtp]
    ...
    \caption{Median (inverse) rank of players against population size}
...
\begin{figure}[!hbtp]
    ...
    \caption{Median (inverse) rank of players against population size with noise}
