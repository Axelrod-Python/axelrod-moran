...
\begin{figure}[!hbtp]
    ...
    % TODO be more selective here: just picking out the ones for which we
    % currently have data
    %\begin{subfigure}[htbp]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/invasion_boxplot_8_std.pdf}
        %\caption{\(N=8\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/invasion_boxplot_10_std.pdf}
        %\caption{\(N=10\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/invasion_boxplot_12_std.pdf}
        %\caption{\(N=12\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/invasion_boxplot_14_std.pdf}
        %\caption{\(N=14\)}
    %\end{subfigure}%
    \caption{Invasion fixation probabilities of all strategies}
    \label{fig:invasion_boxplot_std}
\end{figure}
...
\begin{figure}[!hbtp]
    ...
    %\begin{subfigure}[htbp]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/resistance_boxplot_8_std.pdf}
        %\caption{\(N=8\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/resistance_boxplot_10_std.pdf}
        %\caption{\(N=10\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/resistance_boxplot_12_std.pdf}
        %\caption{\(N=12\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/resistance_boxplot_14_std.pdf}
        %\caption{\(N=14\)}
    %\end{subfigure}%
    \caption{Resistance fixation probabilities of all strategies}
    \label{fig:resistance_boxplot_std}
\end{figure}
...
\begin{figure}[!hbtp]
    ...
    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/coexistance_boxplot_4_std.pdf}
        %\caption{\(N=4\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/coexistance_boxplot_6_std.pdf}
        %\caption{\(N=6\)}
    %\end{subfigure}%
    ...
    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/coexistance_boxplot_10_std.pdf}
        %\caption{\(N=10\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/coexistance_boxplot_12_std.pdf}
        %\caption{\(N=12\)}
    %\end{subfigure}%
...
% TODO Discuss these tables: show that none of the models are great (R^2) BUT it
% does show that the coefficient of the N=2 column is always low whereas the
% coefficient of the N=14 column is high even in the N=4 row. So how well you do
% in  a match (N=2) has got very little to do with an evolutionary process.

\begin{table}[!hbtp]
    \centering
    \begin{subfigure}{.5\textwidth}
        \centering
        \input{"../tbl/linear_coeficients_invasion.tex"}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \input{"../tbl/linear_coeficients_resistance.tex"}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \input{"../tbl/linear_coeficients_coexist.tex"}
