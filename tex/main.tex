...
Figures~\ref{fig:fixation_heatmap_invade} shows the pairwise fitness for
strategies on the columns axis invading a population of strategies on the row
axis.
...
\begin{figure}[!hbtp]
    ...
    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/boxplot_4_coexist.pdf}
        %\caption{\(N=4\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/boxplot_6_coexist.pdf}
        %\caption{\(N=6\)}
    %\end{subfigure}%
    ...
    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/boxplot_10_coexist.pdf}
        %\caption{\(N=10\)}
    %\end{subfigure}%

    %\begin{subfigure}[t]{\textwidth}
        %\centering
        %\includegraphics[width=\textwidth]{../img/boxplot_12_coexist.pdf}
        %\caption{\(N=12\)}
    %\end{subfigure}%
...
\begin{table}[!hbtp]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \input{"../tbl/linear_coeficients_invade.tex"}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \input{"../tbl/linear_coeficients_resist.tex"}
