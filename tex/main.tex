...
individual. The probability with which a given strategy is the survivor is call
the absorption probability. A more detailed analytic description of this is
...
% TODO Cite all relevant pieces of software: pandas, matplotlib, scipy, axelrod
% etc...

% TODO Introduce the next section.
...
(\ref{equ:fixation_probability}) and the actual Moran process for almost all
strategies pairs.
% TODO Discuss why WSLS And TFT do not match.
...
\begin{figure}[!hbtp]
    ...
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{../img/Win-Stay_Lose-Shift_C_v_Tit_For_Tat.pdf}
        \caption{Win Stay Lose Shift and Tit For Tat}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{../img/Alternator_v_Win-Stay_Lose-Shift_C.pdf}
        \caption{Alternator and Win Stay Lose Shift}
    \end{subfigure}%
    % TODO Add Defector v WSLS
...
\begin{figure}[!hbtp]
    ...
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{../img/Random_0_5_v_Cooperator.pdf}
        \caption{Random and Cooperator}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{../img/Random_0_5_v_Defector.pdf}
        \caption{Random and Defector}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{../img/Random_0_5_v_Tit_For_Tat.pdf}
    ...
    \begin{subfigure}[t]{.3\textwidth}
        \centering
        \includegraphics[width=.8\textwidth]{../img/Calculator_v_Random_0_5.pdf}
