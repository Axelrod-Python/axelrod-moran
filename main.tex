...
\begin{abstract}
    ...
    to maximize total payoff while the best resistors invoke handshake mechanism.
...
To complement Figures~\ref{fig:ranks_v_size_invade},~\ref{fig:ranks_v_size_resist}
and~\ref{fig:ranks_v_size_coexist} show
