...
\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=.95\columnwidth]{./Fig6.eps}
...
The top 16 strategies are given in
Tables~\ref{tbl:top_invade_3},\ref{tbl:top_invade_7} and
\ref{tbl:top_invade_14}. A variety of figures showing the performance of all
strategies is available in the supporting information.
...
\begin{table}[!hbtp]
    ...
    \tiny
            ...
            \bottomrule
            \end{tabular}
    \caption{Top invaders for \(N=3\)}
    \label{tbl:top_invade_3}
\end{table}
...
\begin{table}[!hbtp]
    ...
    \tiny
            ...
            \bottomrule
            \end{tabular}
    \caption{Top invaders for \(N=7\)}
    \label{tbl:top_invade_7}
\end{table}
...
\begin{table}[!hbtp]
    ...
    \tiny
            ...
            \bottomrule
            \end{tabular}
    \caption{Top invaders for \(N=14\)}
    \label{tbl:top_invade_14}
\end{table}
...
Tables~\ref{tbl:top_resist_3},~\ref{tbl:top_resist_7} and
\ref{tbl:top_resist_14} show the top strategies when ranked according to
\(x_{N-1}\) for \(N\in\{3, 7, 14\}\) and figures showing results for all
strategies are available in the supplementary materials.  Once again none of the
short memory strategies previously discussed perform well for high \(N\).
...
\begin{table}[!hbtp]
    ...
    \centering
        ...
        \bottomrule
        \end{tabular}
        \caption{Top resistors for \(N=3\)}
    \label{tbl:top_resist_3}
\end{table}
...
\begin{table}[!hbtp]
    ...
    \centering
            ...
            \bottomrule
            \end{tabular}
    \caption{Top resistors for \(N=7\)}
    \label{tbl:top_resist_7}
\end{table}
...
\begin{table}[!hbtp]
    ...
    \centering
        ...
        \bottomrule
        \end{tabular}
    \caption{Top resistors for \(N=14\)}
    \label{tbl:top_resist_14}
\end{table}
...
\bibitem{Knight2016}
Knight V, Campbell O, Harper M, Langner K, Campbell J,
  Campbell T, et al.
...
\bibitem{Mateo2003}
Mateo J.
\newblock {Kin recognition in ground squirrels and other rodents}.
\newblock In {\em Journal of Mammalogy}, 84 (4), 1163--1181

\bibitem{West2016}
West J, Hasnain Z, Mason J, and Newton P.
\newblock {The prisoner’s dilemma as a cancer model}.
\newblock {\em Convergent Science Physical Oncology}, 2(3):035002, 2016.

\bibitem{Nowak2017}
Allen B, Lippner G, Chen Y, Fotouhi B, Momeni N,
...
\bibitem{Harper2017}
Harper M, Knight V, Jones M, Koutsovoulos G, Glynatsi N , and Campbell O.
\newblock {Reinforcement Learning Produces Dominant Strategies for the Iterated
  Prisoner's Dilemma}.
\newblock {\em PLOS ONE}, 12(12): 12 2017.
...
\bibitem{Gaudesi2016}
Gaudesi M, Piccolo E, Squillero G, and Tonda A.
...
Harper M, Knight V, and Jones M.
\newblock Axelrod-python/axelrod-dojo: v0.0.1.
\newblock https://doi.org/10.5281/zenodo.824264, July 2017.

\bibitem{AshlockBook}
Ashlock D.
\newblock{Evolutionary computation for modeling and optimization},
\newblock{Springer Science \& Business Media}
2006

\bibitem{Ashlock2007}
Ashlock W
\newblock {Why some representations are more cooperative than others for
prisoner's dilemma}
\newblock {\em Foundations of Computational Intelligence, 2007. FOCI 2007. IEEE
symposium on}, 314--321,
  2007.

\bibitem{data}
Knight V, Harper M, and Glynatsi N.
...
\bibitem{Hilbe2013}
Hilbe C, Nowak M, and Traulsen A.
...
Beaufils B, Delahaye J, and Mathieu P.
...
\bibitem{Ashlock2014}
Ashlock W, Tsang J, and Ashlock D.
...
\section*{Appendix: List of players}\label{app:list_of_players}
...
\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S1_Fig.eps}
    \textbf{S1 Fig.} The fixation probabilities \(x_1\) for \(N=3\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S2_Fig.eps}
    \textbf{S2 Fig.} The fixation probabilities \(x_1\) for \(N=4\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S3_Fig.eps}
    \textbf{S3 Fig.} The fixation probabilities \(x_1\) for \(N=5\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S4_Fig.eps}
    \textbf{S4 Fig.} The fixation probabilities \(x_1\) for \(N=6\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S5_Fig.eps}
    \textbf{S5 Fig.} The fixation probabilities \(x_1\) for \(N=7\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S6_Fig.eps}
    \textbf{S6 Fig.} The fixation probabilities \(x_1\) for \(N=8\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S7_Fig.eps}
    \textbf{S7 Fig.} The fixation probabilities \(x_1\) for \(N=9\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S8_Fig.eps}
    \textbf{S8 Fig.} The fixation probabilities \(x_1\) for \(N=10\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S9_Fig.eps}
    \textbf{S9 Fig.} The fixation probabilities \(x_1\) for \(N=11\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S10_Fig.eps}
    \textbf{S10 Fig.} The fixation probabilities \(x_1\) for \(N=12\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S11_Fig.eps}
    \textbf{S11 Fig.} The fixation probabilities \(x_1\) for \(N=13\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S12_Fig.eps}
    \textbf{S12 Fig.} The fixation probabilities \(x_1\) for \(N=14\)
\end{figure}


\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S13_Fig.eps}
    \textbf{S13 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=3\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S14_Fig.eps}
    \textbf{S14 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=4\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S15_Fig.eps}
    \textbf{S15 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=5\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S16_Fig.eps}
    \textbf{S16 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=6\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S17_Fig.eps}
    \textbf{S17 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=7\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S18_Fig.eps}
    \textbf{S18 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=8\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S19_Fig.eps}
    \textbf{S19 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=9\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S20_Fig.eps}
    \textbf{S20 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=10\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S21_Fig.eps}
    \textbf{S21 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=11\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S22_Fig.eps}
    \textbf{S22 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=12\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S23_Fig.eps}
    \textbf{S23 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=13\)
\end{figure}

\begin{figure}[!hbtp]
    %\includegraphics[ width=\textwidth]{./S24_Fig.eps}
    \textbf{S24 Fig.} The fixation probabilities \(x_{N-1}\) for \(N=14\)
\end{figure}
