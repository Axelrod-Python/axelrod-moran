...
% TODO Include details about the 3/6 extra FSM strategies.
% Possibly draw pictorial representations?
% Remove the FSM strategies if they don't perform well.
% TODO Decide if we include all 6 (so the same original 3 with the wrong initial
% state) in the entire analysis.
...
\begin{table}[!hbtp]
    \centering
    \scriptsize
    \input{./tex/ZD_ranks_coexist.tex}
