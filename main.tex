...
and~\ref{fig:tf3}).
% TODO Describe what the diagram shows


\begin{figure}[!hbtp]
    \centering
    \scalebox{.5}{\input{tex/fsm_one.tex}}
...
\begin{figure}[!hbtp]
    \centering
    \scalebox{.5}{\input{tex/fsm_two.tex}}
...
% TODO Add a bit more clarity that the cache is indeed stochastic (although not
% when using deterministic strategies.
...
% TODO Are we clear about selection procedure?
% TODO Specify that kill off is uniformly random.
...
\begin{algorithm}[!hbtp]
        ...
        % TODO Add description of number of turns in the IPD
\end{algorithm}
...
% TODO Add description of lines shown.
...
% TODO Rephrase this sentence: possibly when doing the statistical test
...
at \cite{data}.
% TODO Include a statistical test (Bonferroni)

\begin{figure}[!hbtp]
    \centering
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Alternator_v_Cooperator.pdf}
        \caption{Alternator and Cooperator}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Defector_v_Alternator.pdf}
        \caption{Defector and Alternator}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Alternator_v_TfT.pdf}
        \caption{Alternator and Tit For Tat}
    \end{subfigure}%

    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Cooperator_v_TfT.pdf}
        \caption{Cooperator and Tit For Tat}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Defector_v_Cooperator.pdf}
        \caption{Defector and Cooperator}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Defector_v_TfT.pdf}
        \caption{Defector and Tit For Tat}
    \end{subfigure}%

    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/WSLS_v_TfT.pdf}
        \caption{Win Stay Lose Shift and Tit For Tat}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Alternator_v_WSLS.pdf}
        \caption{Alternator and Win Stay Lose Shift}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Defector_v_WSLS.pdf}
    ...
    % TODO DEEMED Unreadable: reduce number of images.
\end{figure}
...
\begin{figure}[!hbtp]
    ...
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Random_v_Cooperator.pdf}
        \caption{Random and Cooperator}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Random_v_Defector.pdf}
        \caption{Random and Defector}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Random_v_TfT.pdf}
        \caption{Random and Tit For Tat}
    \end{subfigure}%

    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/ALLCorALLD_v_Cooperator.pdf}
        \caption{All C or all D and Cooperator}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/ALLCorALLD_v_Defector.pdf}
        \caption{All C or all D and Defector}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Calculator_v_Random.pdf}
        \caption{Calculator and Random}
    \end{subfigure}%

    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Calculator_v_ALLCorALLD.pdf}
        \caption{Calculator and All C or all D}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/Calculator_v_Arrogant_QLearner.pdf}
        \caption{Calculator and Arrogant Q learner}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{.3\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{img/ALLCorALLD_v_TfT.pdf}
...
\begin{figure}[!hbtp]
    ...
    \begin{subfigure}{.5\columnwidth}
        ...
        % TODO Add more summary statistics to this measure
...
\begin{figure}[!hbtp]
    ...
    % TODO Make less bad. Perhaps remove names altogether.
...
% TODO Reduce font
% TODO Add number of states for FSMs
