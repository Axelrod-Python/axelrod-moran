...
are used library. There are \input{./tex/num_stochastic.tex}stochastic and
...
The top strategies are given in Tables~\ref{tbl:top_five_invade}.
...
processes do not appear in the top 5: whereas strategies trained for tournaments do.
...
Table~\ref{tbl:top_five_resist} shows the top strategies when ranked
