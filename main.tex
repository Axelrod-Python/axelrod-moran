...
When $N=2$ the Moran process is effectively a measure of the distribution of 
relative
...
itself constitute an authoritative set. Whilst it is not only large but very
...
the work here (not only is the source code archived but so it the data) this and
