...
\begin{figure}[!hbtp]
    ...
    \caption{TF1: a 16 state finite state machine.}
    \label{fig:tf1}
\end{figure}
...
\begin{figure}[!hbtp]
    ...
    \caption{TF2: a 16 state finite state machine.}
    \label{fig:tf2}
\end{figure}
...
probabilities: almost always acting as expected. Apart from TF3 in \(N=3\), the
