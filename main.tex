...
computational run time. The large number of strategies is available thanks to
...
of Table~\ref{tbl:summary_top_2} performs well for \(N\in\{3, 7, 14\}\). The new
...
Section~\ref{sec:two_individuals} performs well for high \(N\).
