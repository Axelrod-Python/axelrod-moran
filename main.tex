...
The Prisoner's Dilemma (PD)~\cite{Tucker1983} is a fundamental two person game 
...
strategies, the zero determinant strategies, have been introduced. The ZD\@,
...
weakness of the analytical formula that relies on the average payoffs. A
