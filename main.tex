...
Knight V, Campbell O, Harper M, Langner K, Campbell J,
  Campbell T, Carney A, Chorley M, Davidson-pilon C,
  Glynatsi N, Ehrlich T, Jones M, Koutsovoulos G, Muller J, Palmer G, Petunov P, Slavin P,
  Standen T, Visintini L, and Molden K.
...
Wilson G , Aruliah D, Brown T, Chue~Hong N, Davis M ,
  Guy R , Haddock S , Huff K, Mitchell I , Plumbley M , 
  Waugh B , White E , and Wilson P.
...
\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig17.eps}
    \caption{The fixation probabilities \(x_1\) for \(N=8\)}
\end{figure}

\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig18.eps}
    \caption{The fixation probabilities \(x_1\) for \(N=9\)}
\end{figure}

\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig19.eps}
    \caption{The fixation probabilities \(x_1\) for \(N=10\)}
\end{figure}

\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig20.eps}
    \caption{The fixation probabilities \(x_1\) for \(N=11\)}
\end{figure}

\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig21.eps}
    \caption{The fixation probabilities \(x_1\) for \(N=12\)}
\end{figure}

\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig22.eps}
    \caption{The fixation probabilities \(x_1\) for \(N=13\)}
\end{figure}

\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig23.eps}
...
\begin{figure}[!hbtp]
    \centering
    %\includegraphics[ width=\textwidth]{./Fig24.eps}
